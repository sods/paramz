# -*- coding: utf-8 -*-
#
# paramz documentation build configuration file, created by
...
MOCK_MODULES = ['numpy', 'numpy.linalg.linalg', 'scipy.linalg.blas', 'blas',
...
version_dummy = {}
with open('../../paramz/__version__.py', 'r') as f:
...
latex_documents = [
  (master_doc, 'paramz.tex', u'paramz Documentation',
   u'Max Zwiessele', 'manual'),
]
...
man_pages = [
    (master_doc, 'paramz', u'paramz Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'paramz', u'paramz Documentation',
   author, 'paramz', 'One line description of project.',
   'Miscellaneous'),
]
